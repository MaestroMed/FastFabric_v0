/**
 * Site Sur Mesure Service Index Page
 * Route: /site-sur-mesure
 */

import type { Route } from "./+types/service.site-sur-mesure";
...
const SERVICE_SLUG = 'site-sur-mesure';
...
export function meta({}: Route.MetaArgs) {
  ...
  return [
    ...
    { name: 'description', content: `Création de ${service.nom.toLowerCase()} dans tout le Val-d'Oise (95). 184 communes couvertes. Livraison express, design sur mesure, ${service.prix}.` },
      ...
      <main className="pt-20">
        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-6">
            <Breadcrumbs items={[{ label: service.nom }]} className="mb-6" />
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                Création de projets web personnalisés dans toutes les villes du département 95.
                Devis gratuit, conception sur mesure pour vos besoins spécifiques.
              </p>
